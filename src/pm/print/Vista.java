...
public class Vista implements Pageable {
     ...
     * @param format  The description of the pages on to which the canvas will be
     *                drawn.
     */
    ...
    protected void setSize(float width, float height) {
        ...
        mNumPagesX = (int) ((width + mFormat.getImageableWidth() - 1) / mFormat
                .getImageableWidth());
     ...
     *
     * @param pageIndex the zero based index of the page whose PageFormat is being
     *                  requested
     * @return the PageFormat describing the size and orientation.
     * @throws IndexOutOfBoundsException the Pageable does not contain the requested page.
     */
     ...
     * the page specified by <code>pageIndex</code>. In a Vista, all of the
     * pages are drawn with the same Printable. This method however creates a
     ...
     *
     * @param pageIndex the zero based index of the page whose Printable is being
     *                  requested
    ...
    public static final class TranslatedPrintable implements Printable {
         ...
         * @param origin  The point in the canvas that will be mapped to the
         ...
         * The Graphics class or subclass implements the {@link PrinterGraphics}
         * interface to provide additional information. If the Printable object
