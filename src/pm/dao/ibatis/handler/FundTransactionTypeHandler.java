 ...
 * @since 15-Aug-2007
 */
public class FundTransactionTypeHandler implements TypeHandlerCallback {

    public void setParameter(ParameterSetter setter, Object parameter) throws SQLException {
        setter.setInt(((FUND_TRANSACTION_TYPE) parameter).ordinal());
    }

    public Object getResult(ResultGetter getter) throws SQLException {
        int intVal = getter.getInt();
        return FUND_TRANSACTION_TYPE.values()[intVal];
    }

    public Object valueOf(String s) {
        return FUND_TRANSACTION_TYPE.valueOf(s);
    }
}
