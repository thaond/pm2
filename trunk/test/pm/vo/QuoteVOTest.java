...
public class QuoteVOTest extends TestCase {
    ...
    /*
      * Test method for 'pm.vo.EquityQuote.applyPriceFactor(float)'
      */
    public void testApplyPriceFactor() {
        EquityQuote quoteVO = new EquityQuote("stockCode", new PMDate(10, 1, 2005), 100f, 120f, 80f, 110f, 20, 90, 1, 1);
